...
class Dom implements DomInterface
{
     ...
     */
    public function loadFromFile(string $file, \PHPHtmlParser\Options|null $options = null): Dom
    {
    ...
    public function loadFromUrl(string $url, ?Options $options = null, ?ClientInterface $client = null, ?RequestInterface $request = null): Dom
    {
        ...
        if ($request === null) {
//            $http_response_header = array('Accept-Charset'=>'sjis');
     ...
     */
    public function loadStr(string $str, \PHPHtmlParser\Options|null $options = null): Dom
    {
        ...
        $str = mb_convert_encoding($str, 'UTF-8',"ASCII,JIS,UTF-8,EUC-JP,SJIS");
